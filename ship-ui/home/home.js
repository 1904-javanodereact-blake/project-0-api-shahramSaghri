...
async function loadShips() {
  ...
  //if (response.status === 200) {
    ...
    // const currentUserArray = Array.from(currentUser);
    // console.log(currentUserArray);
    populatePageShips(currentUser);
    
  //}
}

function populatePageShips(ship) {
  ...
  // const shipElements = ships.map(ship => {
    ...
    cardTitle.innerText = 'Loged in Username: ' + ship.username;
